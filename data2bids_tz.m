function [cfg] = data2bids_tz(cfg, varargin)
...
cfg.sub       = char(ft_getopt(cfg, 'sub'));
...
for i=1:numel(fn)
  if ischar(cfg.(fn{i})) && any(cfg.(fn{i})=='-')
    ...
    warning('the field cfg.%s cannot contain a "-"', fn{i});
  end
end
